...
<div class="container-fluid row w-100 m-0 p-0" >
    ...
    <div id="carouselExampleControls" class="carousel slide col p-0" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active" data-interval="3000">
                <img src="images/theme/kreaturerare.jpg" class="d-block w-100 cover" alt="...">
            </div>
            <div class="carousel-item" data-interval="3000">
                <img src="images/theme/kreature2.jpg" class="d-block w-100 cover" alt="...">
            </div>
            <div class="carousel-item" data-interval="3000">
            <img src="images/theme/kreature3.jpg" class="d-block w-100 cover" alt="...">
            </div>
        </div>
