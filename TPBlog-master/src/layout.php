...
<head>
    <meta charset="utf-8">
    <title>Sport + Travel + Nature - Un blog dédié aux plus grands plaisirs!</title>
...
<body>
    ...
    <header id="header" class="w-100 m-0 fixed-top" >
        <nav class="navbar navbar-expand-lg navbar-dark bgBlack w-100" style="background-color: black;">
            <a class="navbar-brand" href="index.php"><img class="h-25 w-25"src="images/logo/ancre.jpg" alt=""></a>
    ...
    <footer class="container-fluid bgBlack ">        
        <div>
            <h4 class="text-center textYellow">- Suivez-nous -</h4>
        ...
        <div class="text-center py-1 mb-0 text-white">
            <small>© 2020 - Eat+Travel+Play. Tous droits réservés</small>
        </div>
        <!-- <small>Le blog</small> -->
    </footer>
